...
<body>
    <h1 class="my-5">Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Welcome to our site.You're the administrator.</h1>
    <p>
        <a href="index1.php" class="btn btn-warning">List Data</a>
