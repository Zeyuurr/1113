...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty($name_err) && empty($address_err) && empty($salary_err) && empty($username_err) && empty($password_err)){
        ...
        $sql = "INSERT INTO user (name, address, salary, username, password) VALUES (?, ?, ?, ?, ?)";
...
<div id="header-wrapper">
    <div class="banner">
    <img src='product-images/Logo1.png' class='writer-img'>
	<div id="header" class="container">
		...
		<div id="menu">
			<ul>
				...
				<li class="active"><a href="upload.html" accesskey="3" title="">Register ＆ Login</a></li>
...
<div class="footer">
		<p4>Luca’s Loaves &nbsp;&nbsp;11-2022</p4><br>
		<p4>IT20_2_218 IKUN: Milk, Zain, Gethin, November</p4>
	</div>
</body>
</html>
